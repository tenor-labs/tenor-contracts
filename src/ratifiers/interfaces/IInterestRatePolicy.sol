...
/// internally, the user address (the position owner being renewed), the source and target maturities for context,
/// and the user's side for direction-aware pricing.
