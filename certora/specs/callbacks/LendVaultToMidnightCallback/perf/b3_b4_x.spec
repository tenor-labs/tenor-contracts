// perf overlay LendVaultToMidnightCallback/many: branches B3, B4 disabled — per the footprint matrix
...
// BASE: light
// STUBS: B3,B4
// B7-ELIGIBLE (hashing flags, deferred to keccak inventory): tickFeeVanishesAtPar
