// perf overlay LendVaultToMidnightCallback/many: branches B3 disabled — per the footprint matrix
...
// BASE: light
// STUBS: B3
// B7-ELIGIBLE (hashing flags, deferred to keccak inventory): lenderFeeBoundedByInterestShare
// SATISFY-TWINS (re-check non-vacuity under the same overlay): lenderFeeBoundedByInterestShare
...
use rule lenderFeeBoundedByInterestShare;
use rule lenderFeeBoundedByInterestShare__satisfy;
