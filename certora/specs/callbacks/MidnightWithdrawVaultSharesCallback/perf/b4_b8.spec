// perf overlay MidnightWithdrawVaultSharesCallback/many: branches B4, B8 disabled — per the footprint matrix
...
// RULES: callbackHoldsZeroAllowance takeLeavesVaultShareBalanceUnchanged
// BASE: light
// STUBS: B4,B8
// B7-ELIGIBLE (hashing flags, deferred to keccak inventory): callbackHoldsZeroAllowance
// SATISFY-TWINS (re-check non-vacuity under the same overlay): callbackHoldsZeroAllowance takeLeavesVaultShareBalanceUnchanged
...
use rule takeLeavesVaultShareBalanceUnchanged;
use rule callbackHoldsZeroAllowance__satisfy;
use rule takeLeavesVaultShareBalanceUnchanged__satisfy;
