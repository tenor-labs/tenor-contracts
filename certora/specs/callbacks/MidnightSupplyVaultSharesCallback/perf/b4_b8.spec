// perf overlay MidnightSupplyVaultSharesCallback/many: branches B4, B8 disabled — per the footprint matrix
...
// RULES: callbackHoldsZeroAllowance supplyMonotoneCollateral bystanderUntouched
// BASE: light
// STUBS: B4,B8
// B7-ELIGIBLE (hashing flags, deferred to keccak inventory): callbackHoldsZeroAllowance supplyMonotoneCollateral
