// perf overlay MidnightSupplyVaultSharesCallback/one: branches B4, B8 disabled — per the footprint matrix
...
// RULES: supplyCanRaiseVaultCollateral vaultShareBeneficiaryIsSeller extraPullMatchesPercentFormula
// BASE: light
// STUBS: B4,B8
// B7-ELIGIBLE (hashing flags, deferred to keccak inventory): supplyCanRaiseVaultCollateral vaultShareBeneficiaryIsSeller
// SATISFY-TWINS (re-check non-vacuity under the same overlay): vaultShareBeneficiaryIsSeller
...
use rule supplyCanRaiseVaultCollateral;
use rule vaultShareBeneficiaryIsSeller;
use rule vaultShareBeneficiaryIsSeller__satisfy;
use rule extraPullMatchesPercentFormula;
