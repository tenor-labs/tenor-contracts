// perf overlay MidnightSupplyVaultSharesCallback/many: branches B3, B4, B8 disabled — per the footprint matrix
...
// RULES: callbackRevertsForNonMidnightCaller callbackRevertsOnZeroAssetsOrUnits noExtraPullWhenPercentZero receiverNotCallbackReverts vaultAssetMismatchReverts vaultNotAtIndexReverts
// BASE: light
// STUBS: B3,B4,B8
// B7-ELIGIBLE (hashing flags, deferred to keccak inventory): callbackRevertsForNonMidnightCaller noExtraPullWhenPercentZero
...
use rule noExtraPullWhenPercentZero;
use rule receiverNotCallbackReverts;
use rule vaultAssetMismatchReverts;
use rule vaultNotAtIndexReverts;
