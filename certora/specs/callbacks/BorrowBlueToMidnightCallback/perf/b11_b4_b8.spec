// perf overlay BorrowBlueToMidnightCallback/one: branches B11, B4, B8 disabled — per the footprint matrix
...
// BASE: light
// STUBS: B11,B4,B8
// KNOWN-FAIL: this profile over-approximates callbackHoldsZeroAllowance (spurious CEX) — research record only, rejected per the ledger's acceptance criterion (do not read its result as a verdict).
