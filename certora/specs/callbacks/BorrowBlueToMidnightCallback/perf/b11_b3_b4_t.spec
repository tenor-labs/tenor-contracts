// perf overlay BorrowBlueToMidnightCallback/many: branches B11, B3, B4 disabled — per the footprint matrix
...
// BASE: light
// STUBS: B11,B3,B4
// B7-ELIGIBLE (hashing flags, deferred to keccak inventory): clearingOldDebtAlsoEmptiesOldCollateral
// SATISFY-TWINS (re-check non-vacuity under the same overlay): clearingOldDebtAlsoEmptiesOldCollateral
...
use rule clearingOldDebtAlsoEmptiesOldCollateral;
use rule clearingOldDebtAlsoEmptiesOldCollateral__satisfy;
