// perf overlay BorrowBlueToMidnightCallback/many: branches B11, B2, B3, B4 disabled — per the footprint matrix
...
// BASE: light
// STUBS: B11,B2,B3,B4
// B7-ELIGIBLE (hashing flags, deferred to keccak inventory): migrationOnlyReducesOldBlueDebt
// SATISFY-TWINS (re-check non-vacuity under the same overlay): migrationOnlyReducesOldBlueDebt
...
use rule migrationOnlyReducesOldBlueDebt;
use rule migrationOnlyReducesOldBlueDebt__satisfy;
