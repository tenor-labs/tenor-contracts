// perf overlay BorrowBlueToMidnightCallback/many: branches B1, B11, B2, B4, B8 disabled — per the footprint matrix
...
// BASE: light
// STUBS: B1,B11,B2,B4,B8
// B7-ELIGIBLE (hashing flags, deferred to keccak inventory): migrationOnlyAddsNewMidnightCollateral
// SATISFY-TWINS (re-check non-vacuity under the same overlay): migrationOnlyAddsNewMidnightCollateral
...
use rule migrationOnlyAddsNewMidnightCollateral;
use rule migrationOnlyAddsNewMidnightCollateral__satisfy;
