// perf overlay BorrowBlueToMidnightCallback/many: branches B1, B11, B2, B8 disabled — per the footprint matrix
...
// RULES: thirdPartyBalanceUnchanged
// BASE: light
// STUBS: B1,B11,B2,B8
// B7-ELIGIBLE (hashing flags, deferred to keccak inventory): thirdPartyBalanceUnchanged
// SATISFY-TWINS (re-check non-vacuity under the same overlay): thirdPartyBalanceUnchanged
...
use rule thirdPartyBalanceUnchanged;
use rule thirdPartyBalanceUnchanged__satisfy;
