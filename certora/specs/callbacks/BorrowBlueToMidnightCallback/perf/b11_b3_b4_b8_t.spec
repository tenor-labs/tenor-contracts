// perf overlay BorrowBlueToMidnightCallback/many: branches B11, B3, B4, B8 disabled — per the footprint matrix
...
// RULES: fullCollateralMigrationClearsAllOldDebt migrationOnlyWithdrawsOldBlueCollateral
// BASE: light
// STUBS: B11,B3,B4,B8
// B7-ELIGIBLE (hashing flags, deferred to keccak inventory): fullCollateralMigrationClearsAllOldDebt migrationOnlyWithdrawsOldBlueCollateral
// SATISFY-TWINS (re-check non-vacuity under the same overlay): fullCollateralMigrationClearsAllOldDebt migrationOnlyWithdrawsOldBlueCollateral
...
use rule fullCollateralMigrationClearsAllOldDebt;
use rule migrationOnlyWithdrawsOldBlueCollateral;
use rule fullCollateralMigrationClearsAllOldDebt__satisfy;
use rule migrationOnlyWithdrawsOldBlueCollateral__satisfy;
