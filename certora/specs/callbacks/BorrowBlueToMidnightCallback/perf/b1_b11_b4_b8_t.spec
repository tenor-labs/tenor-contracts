// perf overlay BorrowBlueToMidnightCallback/many: branches B1, B11, B4, B8 disabled — per the footprint matrix
...
// BASE: light
// STUBS: B1,B11,B4,B8
// B7-ELIGIBLE (hashing flags, deferred to keccak inventory): migrationConservesMigratedCollateral
// SATISFY-TWINS (re-check non-vacuity under the same overlay): migrationConservesMigratedCollateral
...
use rule migrationConservesMigratedCollateral;
use rule migrationConservesMigratedCollateral__satisfy;
