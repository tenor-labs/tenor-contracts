// perf overlay BorrowBlueToMidnightCallback/many: branches B1, B11, B2, B3, B4, B8 disabled — per the footprint matrix
...
// RULES: callbackRevertsForNonMidnightCaller callbackRevertsOnZeroAssetsOrUnits receiverNotCallbackReverts
// BASE: light
// STUBS: B1,B11,B2,B3,B4,B8
