// perf overlay BorrowMidnightToBlueCallback/many: branches B1, B3, B4, B8 disabled — per the footprint matrix
...
// RULES: percentageFeeNeverExceedsAssets percentageFeeRateAboveCapReverts
// BASE: light
// STUBS: B1,B3,B4,B8
...
use rule percentageFeeRateAboveCapReverts;
