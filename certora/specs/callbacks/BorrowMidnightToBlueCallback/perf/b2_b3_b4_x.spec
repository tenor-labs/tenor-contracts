// perf overlay BorrowMidnightToBlueCallback/many: branches B2, B3, B4 disabled — per the footprint matrix
...
// BASE: light
// STUBS: B2,B3,B4
// B7-ELIGIBLE (hashing flags, deferred to keccak inventory): migrationOnlyOpensNewBlueDebt
// SATISFY-TWINS (re-check non-vacuity under the same overlay): migrationOnlyOpensNewBlueDebt
...
use rule migrationOnlyOpensNewBlueDebt;
use rule migrationOnlyOpensNewBlueDebt__satisfy;
