// perf overlay BorrowMidnightToBlueCallback/many: branches B8 disabled — per the footprint matrix
...
// BASE: light
// STUBS: B8
// SATISFY-TWINS (re-check non-vacuity under the same overlay): migrationFinalFillTransfersAllOldMidnightCollateral
...
use rule migrationFinalFillTransfersAllOldMidnightCollateral;
use rule migrationFinalFillTransfersAllOldMidnightCollateral__satisfy;
