// perf overlay BorrowMidnightToBlueCallback/one: branches B1, B3, B8 disabled — per the footprint matrix
...
function accrueInterestFrozenCVL(env e, MorphoHarness.MarketParams marketParams, MorphoHarness.Id id) {
    require(to_mathint(ghostMbOneLastUpdate128) == to_mathint(e.block.timestamp),
