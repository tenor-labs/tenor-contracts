// perf overlay BorrowMidnightToBlueCallback/many: branches B3, B4, B8 disabled — per the footprint matrix
...
// BASE: light
// STUBS: B3,B4,B8
// B7-ELIGIBLE (hashing flags, deferred to keccak inventory): migrationOnlyAddsNewBlueCollateral
// SATISFY-TWINS (re-check non-vacuity under the same overlay): migrationOnlyAddsNewBlueCollateral
...
use rule migrationOnlyAddsNewBlueCollateral;
use rule migrationOnlyAddsNewBlueCollateral__satisfy;
