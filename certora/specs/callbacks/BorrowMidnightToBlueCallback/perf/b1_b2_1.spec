// perf overlay BorrowMidnightToBlueCallback/one: branches B1, B2 disabled — per the footprint matrix
...
function accrueInterestFrozenCVL(env e, MorphoHarness.MarketParams marketParams, MorphoHarness.Id id) {
    require(ghostMbOneLastUpdate128 == to_mathint(e.block.timestamp),
...
use rule oldMidnightDebtAndNewBlueDebtMoveTogether;
