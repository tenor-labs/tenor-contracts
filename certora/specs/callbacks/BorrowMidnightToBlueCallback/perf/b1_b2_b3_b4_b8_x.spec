// perf overlay BorrowMidnightToBlueCallback/many: branches B1, B2, B3, B4, B8 disabled — per the footprint matrix
...
// RULES: callbackRevertsForNonMidnightCaller callbackRevertsOnZeroAssetsOrUnits
// BASE: light
// STUBS: B1,B2,B3,B4,B8
