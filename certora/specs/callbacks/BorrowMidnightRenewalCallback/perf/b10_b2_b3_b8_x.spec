// perf overlay BorrowMidnightRenewalCallback/many: branches B10, B2, B3, B8 disabled — per the footprint matrix
...
// BASE: light
// STUBS: B10,B2,B3,B8
// B7-ELIGIBLE (hashing flags, deferred to keccak inventory): renewalReducesDebtOnAtMostOneMarket
// SATISFY-TWINS (re-check non-vacuity under the same overlay): renewalReducesDebtOnAtMostOneMarket
...
use rule renewalReducesDebtOnAtMostOneMarket;
use rule renewalReducesDebtOnAtMostOneMarket__satisfy;
