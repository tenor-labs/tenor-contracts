// perf overlay BorrowMidnightRenewalCallback/many: branches B10, B3 disabled — per the footprint matrix
...
// BASE: light
// STUBS: B10,B3
// B7-ELIGIBLE (hashing flags, deferred to keccak inventory): renewalCallbackNeverPullsExternalLoanToken
// SATISFY-TWINS (re-check non-vacuity under the same overlay): renewalCallbackNeverPullsExternalLoanToken
