// perf overlay BorrowMidnightRenewalCallback/many: branches B10, B2, B3, B4, B8 disabled — per the footprint matrix
...
// RULES: callbackRevertsForNonMidnightCaller callbackRevertsForSameSourceMarket callbackRevertsOnZeroAssetsOrUnits receiverNotCallbackReverts
// BASE: light
// STUBS: B10,B2,B3,B4,B8
// B7-ELIGIBLE (hashing flags, deferred to keccak inventory): callbackRevertsForNonMidnightCaller receiverNotCallbackReverts
