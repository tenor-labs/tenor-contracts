// perf overlay BorrowMidnightRenewalCallback/many: branches B10 disabled — per the footprint matrix
...
// BASE: light
// STUBS: B10
// SATISFY-TWINS (re-check non-vacuity under the same overlay): callbackNeverHoldsTokens
...
use rule callbackNeverHoldsTokens;
use rule callbackNeverHoldsTokens__satisfy;
