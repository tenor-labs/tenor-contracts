// perf overlay BorrowMidnightRenewalCallback/many: branches B10, B3, B4, B8 disabled — per the footprint matrix
...
// RULES: sellerTickFeeNeverExceedsAssets tickFeeVanishesAtPar
// BASE: light
// STUBS: B10,B3,B4,B8
...
use rule sellerTickFeeNeverExceedsAssets;
