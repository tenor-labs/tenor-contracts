// perf overlay BorrowMidnightRenewalCallback/many: branches B10, B2, B3 disabled — per the footprint matrix
...
// RULES: renewalAddsDebtOnAtMostOneMarket
// BASE: light
// STUBS: B10,B2,B3
// SATISFY-TWINS (re-check non-vacuity under the same overlay): renewalAddsDebtOnAtMostOneMarket
...
use rule renewalAddsDebtOnAtMostOneMarket;
use rule renewalAddsDebtOnAtMostOneMarket__satisfy;
