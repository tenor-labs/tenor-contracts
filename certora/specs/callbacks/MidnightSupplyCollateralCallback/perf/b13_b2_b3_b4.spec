// perf overlay MidnightSupplyCollateralCallback/many: branches B13, B2, B3, B4 disabled — per the footprint matrix
...
// RULES: callbackRevertsForNonMidnightCaller callbackRevertsOnZeroAssetsOrUnits collateralLengthMismatchReverts offerSellerAssetsZeroReverts
// BASE: light
// STUBS: B13,B2,B3,B4
...
use rule collateralLengthMismatchReverts;
use rule offerSellerAssetsZeroReverts;
