// perf overlay MidnightSupplyCollateralCallback/many: branches B13, B2 disabled — per the footprint matrix
...
// RULES: bystanderUntouched thirdPartyBalanceUnchanged
// BASE: light
// STUBS: B13,B2
// B7-ELIGIBLE (hashing flags, deferred to keccak inventory): bystanderUntouched thirdPartyBalanceUnchanged
