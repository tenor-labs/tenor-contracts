// perf overlay LendMidnightRenewalCallback/many: branches B2, B3, B4, B8 disabled — per the footprint matrix
...
// RULES: renewalCallbackNeverPullsExternalLoanToken renewalNeverTouchesUnrelatedLenderCredit
// BASE: light
// STUBS: B2,B3,B4,B8
