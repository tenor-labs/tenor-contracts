// perf overlay LendMidnightRenewalCallback/many: branches B12, B3, B8 disabled — per the footprint matrix
...
// RULES: feeRecipientNeverLosesTokens
// BASE: light
// STUBS: B12,B3,B8
// SATISFY-TWINS (re-check non-vacuity under the same overlay): feeRecipientNeverLosesTokens
...
use rule feeRecipientNeverLosesTokens;
use rule feeRecipientNeverLosesTokens__satisfy;
