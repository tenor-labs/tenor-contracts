// perf overlay LendMidnightRenewalCallback/many: branches B2, B3 disabled — per the footprint matrix
...
// RULES: renewalAddsCreditOnAtMostOneMarket renewalReducesCreditOnAtMostOneMarket
// BASE: light
// STUBS: B2,B3
