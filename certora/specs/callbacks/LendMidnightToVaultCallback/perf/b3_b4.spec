// perf overlay LendMidnightToVaultCallback/many: branches B3, B4 disabled — per the footprint matrix
...
// RULES: callbackRevertsForNonMidnightCaller callbackRevertsOnZeroAssetsOrUnits percentageFeeNeverExceedsAssets
// BASE: light
// STUBS: B3,B4
...
use rule percentageFeeNeverExceedsAssets;
