...
function setupEnv(env e) {
    require(e.msg.value == 0, "SAFE: no ETH -- Morpho has no payable functions");
    require(e.msg.sender != 0, "SAFE: non-zero sender");
    require(e.msg.sender != currentContract, "SAFE: sender is not Morpho");
