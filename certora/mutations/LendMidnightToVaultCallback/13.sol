/* ── MUTATION LendMidnightToVaultCallback #13 ──────────────────────────────
 * @desc:   onSell inserts foreign credit redemption on feeRecipient : reduces a bystander's credit
 * @rules:  vaultExitNeverTouchesUnrelatedUser
 * @conf:   certora/confs/callbacks/LendMidnightToVaultCallback/vaultExitNeverTouchesUnrelatedUser.conf
 * @status: killed
