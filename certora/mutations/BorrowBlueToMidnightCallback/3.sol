/* ── MUTATION BorrowBlueToMidnightCallback #3 ──────────────────────────────
 * @desc:   onSell final-fill collateral blueCollateral -1 : debt fully clears but 1 wei collateral remains (coupling broken)
 * @rules:  clearingOldDebtAlsoEmptiesOldCollateral
 * @conf:   certora/confs/callbacks/BorrowBlueToMidnightCallback/clearingOldDebtAlsoEmptiesOldCollateral.conf
 * @status: killed
