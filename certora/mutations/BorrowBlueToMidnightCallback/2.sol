/* ── MUTATION BorrowBlueToMidnightCallback #2 ──────────────────────────────
 * @desc:   supplyCollateral amount forced to 0: collateral never lands on Midnight, migration cannot move it
 * @rules:  migrationCanMoveCollateralBlueToMidnight
 * @conf:   certora/confs/callbacks/BorrowBlueToMidnightCallback/migrationCanMoveCollateralBlueToMidnight.conf
 * @status: killed
 ...
 * Now:     MORPHO_MIDNIGHT.supplyCollateral(market, collateralIndex, 0, seller);
 * ────────────────────────────────────────────────────────────────────*/
