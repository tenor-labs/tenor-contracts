/* ── MUTATION BaseMigrationRatifier #47 ──────────────────────────────
 * @desc:   continuous-fee lifetime * -> + : high fee no longer reaches WAD cap, over-cap offer accepted
 * @rules:  continuousFeeCapReverts
 * @conf:   certora/confs/ratifier/revert.conf
 * @status: killed
 * @target: src/ratifiers/BaseMigrationRatifier.sol
 * Was:     uint256 fee = continuousFee * timeToMaturity;
 * Now:     uint256 fee = continuousFee + timeToMaturity;
 * ────────────────────────────────────────────────────────────────────*/
