/* ── MUTATION BaseMigrationRatifier #33 ──────────────────────────────
 * @desc:   wrong var: rate-limit slot clobbered with policyRate, real gate diverges from reconstruction's real limit
 * @rules:  lenderRateGateMatchesNetBuyerThreshold, borrowerRateGateMatchesNetSellerThreshold
 * @conf:   certora/confs/ratifier/highlevel.conf
 * @status: killed
 * @target: src/ratifiers/BaseMigrationRatifier.sol
 * Was:     userIsBuy, effUnitsPerWad, effPrice, params.limitRatePerSecond, policyRate, duration
 * Now:     userIsBuy, effUnitsPerWad, effPrice, policyRate, policyRate, duration
 * ────────────────────────────────────────────────────────────────────*/
