/* ── MUTATION BaseMigrationRatifier #48 ──────────────────────────────
 * @desc:   Comment out the feeRecipient assignment so setFeeConfig stores only the rate, breaking fee-slot write fidelity
 * @rules:  setFeeConfigWritesSlotAndLeavesOthers
 * @conf:   certora/confs/ratifier/unit.conf
 * @status: killed
 * @target: src/ratifiers/BaseMigrationRatifier.sol
 * Was:     slot.feeRecipient = _feeRecipient;
 * Now:     // slot.feeRecipient = _feeRecipient;
 * ────────────────────────────────────────────────────────────────────*/
