/* ── MUTATION BaseMigrationRatifier #20 ──────────────────────────────
 * @desc:   _maxFeeRate exit-cap removed: cap nonzero (MAX_FEE_RATE) on V2->V1 exits instead of 0
 * @rules:  maxFeeRateZeroOnV2ToV1Exits
 * @conf:   certora/confs/ratifier/unit.conf
 * @status: killed
 * @target: src/ratifiers/BaseMigrationRatifier.sol
 * Was:     return MAX_FEE_RATE_FIXED_TO_VARIABLE;
 * Now:     return MAX_FEE_RATE;
 * ────────────────────────────────────────────────────────────────────*/
