/* ── MUTATION BaseMigrationRatifier #1 ──────────────────────────────
 * @desc:   _ratifyWindow guard ==0 -> !=0
 * @rules:  v2v1ExitsHaveNoRenewalCadenceConstraint
 * @conf:   certora/confs/ratifier/highlevel.conf
 * @status: killed
 * @target: src/ratifiers/BaseMigrationRatifier.sol
 * Was:     if (sourceMaturity == 0) {
 * Now:     if (sourceMaturity != 0) {
 * ────────────────────────────────────────────────────────────────────*/
