/* ── MUTATION BaseMigrationRatifier #41 ──────────────────────────────
 * @desc:   fee-market ternary swapped: consults wrong market slot
 * @rules:  feeMarketIdIgnoresCrossMarketSlot
 * @conf:   certora/confs/ratifier/highlevel.conf
 * @status: killed
 * @target: src/ratifiers/BaseMigrationRatifier.sol
 * Was:     bytes32 feeMarketId = targetMaturity == 0 ? callbackSourceMarketId : callbackTargetMarketId;
 * Now:     bytes32 feeMarketId = targetMaturity == 0 ? callbackTargetMarketId : callbackSourceMarketId;
 * ────────────────────────────────────────────────────────────────────*/
