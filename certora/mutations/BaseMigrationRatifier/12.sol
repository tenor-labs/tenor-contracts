/* ── MUTATION BaseMigrationRatifier #12 ──────────────────────────────
 * @desc:   Accept fee rate mismatch when recipient matches
 ...
 * Was:     if (callbackFeeRate != expectedFee.feeRate || callbackFeeRecipient != expectedFee.feeRecipient) {
 * Now:     if (callbackFeeRate == expectedFee.feeRate || callbackFeeRecipient != expectedFee.feeRecipient) {
 * ────────────────────────────────────────────────────────────────────*/
