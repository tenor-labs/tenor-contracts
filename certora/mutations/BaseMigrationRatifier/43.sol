/* ── MUTATION BaseMigrationRatifier #43 ──────────────────────────────
 * @desc:   unauthorized-callback revert disabled (if(false)): accepts unknown callback
 * @rules:  unauthorizedCallbackReverts
 * @conf:   certora/confs/ratifier/revert.conf
 * @status: killed
 * @target: src/ratifiers/BaseMigrationRatifier.sol
 * Was:     revert InvalidCallback();
 * Now:     if (false) revert InvalidCallback();
 * ────────────────────────────────────────────────────────────────────*/
