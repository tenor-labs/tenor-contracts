/* ── MUTATION MidnightSupplyCollateralCallback #2 ──────────────────────────────
 * @desc:   zero-amount guard || -> &&
 * @rules:  callbackRevertsOnZeroAssetsOrUnits
 * @conf:   certora/confs/callbacks/MidnightSupplyCollateralCallback/callbackRevertsOnZeroAssetsOrUnits.conf
 * @status: killed
 * @target: src/callbacks/MidnightSupplyCollateralCallback.sol
 * Was:     if (sellerAssets == 0 || units == 0) revert CallbackLib.ZeroAmount();
 * Now:     if (sellerAssets == 0 && units == 0) revert CallbackLib.ZeroAmount();
 * ────────────────────────────────────────────────────────────────────*/
