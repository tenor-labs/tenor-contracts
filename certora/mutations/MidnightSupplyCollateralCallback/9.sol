/* ── MUTATION MidnightSupplyCollateralCallback #9 ──────────────────────────────
 * @desc:   supplyCollateral amount forced to 0: position collateral never rises, satisfy witness gone
 * @rules:  supplyCanRaiseCollateral
 * @conf:   certora/confs/callbacks/MidnightSupplyCollateralCallback/supplyCanRaiseCollateral.conf
 * @status: killed
