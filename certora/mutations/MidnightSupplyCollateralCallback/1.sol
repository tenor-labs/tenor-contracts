/* ── MUTATION MidnightSupplyCollateralCallback #1 ──────────────────────────────
 * @desc:   auth guard flipped (!= -> ==)
 * @rules:  callbackRevertsForNonMidnightCaller
 * @conf:   certora/confs/callbacks/MidnightSupplyCollateralCallback/callbackRevertsForNonMidnightCaller.conf
 * @status: killed
