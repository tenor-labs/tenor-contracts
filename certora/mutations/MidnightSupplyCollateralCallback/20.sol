/* ── MUTATION MidnightSupplyCollateralCallback #20 ──────────────────────────────
 * @desc:   supplyCollateral beneficiary seller -> receiver : a bystander's collateral is credited by the supply
 * @rules:  bystanderUntouched
 * @conf:   certora/confs/callbacks/MidnightSupplyCollateralCallback/bystanderUntouched.conf
 * @status: killed
 ...
 * Now:     MORPHO_MIDNIGHT.supplyCollateral(market, i, supplyAmount, receiver);
 * ────────────────────────────────────────────────────────────────────*/
