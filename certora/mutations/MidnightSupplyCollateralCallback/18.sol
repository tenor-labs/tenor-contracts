/* ── MUTATION MidnightSupplyCollateralCallback #18 ──────────────────────────────
 * @desc:   pro-rata supplyAmount operands swapped (fill/cap inverted) : partial fill supplies MORE than the configured per-slot amount
 * @rules:  proRataUpperBound
 * @conf:   certora/confs/callbacks/MidnightSupplyCollateralCallback/proRataUpperBound.conf
 * @status: killed
 * @target: src/callbacks/MidnightSupplyCollateralCallback.sol
 * Was:     uint256 supplyAmount = configAmount.mulDivDown(sellerAssets, callbackData.offerSellerAssets);
 * Now:     uint256 supplyAmount = configAmount.mulDivDown(callbackData.offerSellerAssets, sellerAssets);
 * ────────────────────────────────────────────────────────────────────*/
