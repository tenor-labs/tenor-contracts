/* ── MUTATION MidnightSupplyCollateralCallback #21 ──────────────────────────────
 * @desc:   supplyCollateral -> withdrawCollateral : the callback withdraws, so the seller's collateral DECREASES
 * @rules:  supplyMonotoneCollateral
 * @conf:   certora/confs/callbacks/MidnightSupplyCollateralCallback/supplyMonotoneCollateral.conf
 * @status: killed
 ...
 * Now:     MORPHO_MIDNIGHT.withdrawCollateral(market, i, supplyAmount, seller, address(this));
 * ────────────────────────────────────────────────────────────────────*/
