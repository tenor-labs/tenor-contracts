/* ── MUTATION LendMidnightRenewalCallback #8 ──────────────────────────────
 * @desc:   Flip fee condition: transfers fee only when fee is zero instead of when it's positive
 * @rules:  positiveFeeIsPayable
 * @conf:   certora/confs/callbacks/LendMidnightRenewalCallback/perf/positiveFeeIsPayable.conf
 * @status: killed
