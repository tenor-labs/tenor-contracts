/* ── MUTATION LendVaultToMidnightCallback #11 ──────────────────────────────
 * @desc:   Doubling the fee transfer pushes the fee recipient's loanToken balance delta past the interest-share bound, so lenderFeeBoundedByInterestShare flips to a counterexample.
 * @rules:  lenderFeeBoundedByInterestShare
 * @conf:   certora/confs/callbacks/LendVaultToMidnightCallback/perf/lenderFeeBoundedByInterestShare.conf
 * @status: killed
