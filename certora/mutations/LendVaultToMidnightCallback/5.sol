/* ── MUTATION LendVaultToMidnightCallback #5 ──────────────────────────────
 * @desc:   Approving zero assets instead of buyerAssets prevents Midnight from pulling the loan funding, blocking credit increase for the buyer.
 * @rules:  vaultFundedLendCanRaiseCredit
 * @conf:   certora/confs/callbacks/LendVaultToMidnightCallback/vaultFundedLendCanRaiseCredit.conf
 * @status: killed
