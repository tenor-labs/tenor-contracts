/* ── MUTATION PriceLib #2 ──────────────────────────────
 * @desc:   denominator rate*dur -> rate+dur (formula broken, rounding intact)
 * @rules:  priceFollowsZeroCouponFormula
 * @conf:   certora/confs/ratifier/unit.conf
 * @status: killed
 * @target: src/libraries/PriceLib.sol
 * Was:     uint256 denominator = WAD + ratePerSecond * durationSeconds;
 * Now:     uint256 denominator = WAD + ratePerSecond + durationSeconds;
 * ────────────────────────────────────────────────────────────────────*/
