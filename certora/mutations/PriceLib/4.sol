/* ── MUTATION PriceLib #4 ──────────────────────────────
 * @desc:   satisfiesRateLimit lender <= to >= [same diff as PriceLib#9, re-proven under highlevel.conf]
 * @rules:  satisfiesRateLimitComparisonDirection, satisfiesRateLimitMonotoneInLenderLimit
