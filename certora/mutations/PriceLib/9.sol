/* ── MUTATION PriceLib #9 ──────────────────────────────
 * @desc:   lender rate-limit compare <= -> >= : breaks gate-vs-reconstruction binding [same diff as PriceLib#4, re-proven under unit.conf]
 * @rules:  higherFeeOnlyTightensLenderRateGate
