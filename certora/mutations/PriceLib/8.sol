/* ── MUTATION PriceLib #8 ──────────────────────────────
 * @desc:   borrower rate-limit compare >= -> <= : breaks gate-vs-reconstruction binding [same diff as PriceLib#7, re-proven under unit.conf]
 * @rules:  higherFeeOnlyTightensBorrowerRateGate
