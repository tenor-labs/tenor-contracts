/* ── MUTATION MidnightWithdrawVaultSharesCallback #1 ──────────────────────────────
 * @desc:   off-by-one over-withdraw: sharesToWithdraw + 1 leaves a residual vault share in the callback
 * @rules:  takeLeavesVaultShareBalanceUnchanged
 * @conf:   certora/confs/callbacks/MidnightWithdrawVaultSharesCallback/takeLeavesVaultShareBalanceUnchanged.conf
 * @status: killed
 ...
 * Now:     MORPHO_MIDNIGHT.withdrawCollateral(market, callbackData.collateralIndex, sharesToWithdraw + 1, buyer, address(this));
 * ────────────────────────────────────────────────────────────────────*/
