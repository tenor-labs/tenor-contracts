/* ── MUTATION BorrowMidnightToBlueCallback #9 ──────────────────────────────
 * @desc:   withdrawCollateral commented out: collateral never leaves Midnight, migration cannot move it
 * @rules:  migrationCanMoveCollateralMidnightToBlue
 * @conf:   certora/confs/callbacks/BorrowMidnightToBlueCallback/migrationCanMoveCollateralMidnightToBlue.conf
 * @status: killed
 ...
 * Now:     // MORPHO_MIDNIGHT.withdrawCollateral(market, collateralIndex, collateralMigrated, buyer, address(this));
 * ────────────────────────────────────────────────────────────────────*/
