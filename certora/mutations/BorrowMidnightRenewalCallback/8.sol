/* ── MUTATION BorrowMidnightRenewalCallback #8 ──────────────────────────────
 * @desc:   Changing repayBudget to 0 prevents any debt repayment on the source market, making it impossible to satisfy the goal of moving debt from source to target market.
 * @rules:  renewalCanMoveDebtBetweenMarkets
 * @conf:   certora/confs/callbacks/BorrowMidnightRenewalCallback/renewalCanMoveDebtBetweenMarkets.conf
 * @status: killed
 * @target: src/callbacks/BorrowMidnightRenewalCallback.sol
 * Was:     MORPHO_MIDNIGHT.repay(callbackData.sourceMarket, repayBudget, seller, address(0), "");
 * Now:     MORPHO_MIDNIGHT.repay(callbackData.sourceMarket, 0, seller, address(0), "");
 * ────────────────────────────────────────────────────────────────────*/
