/* ── MUTATION BorrowMidnightRenewalCallback #33 ──────────────────────────────
 * @desc:   onSell receiver guard inverted (!= to ==) so every take-driven onSell reverts and the receiver-narrowed callbackNeverHoldsTokens__satisfy witness becomes UNSAT.
 * @rules:  callbackNeverHoldsTokens__satisfy
 * @conf:   certora/confs/callbacks/BorrowMidnightRenewalCallback/perf_satisfy/callbackNeverHoldsTokens.conf
 * @status: killed
