/* ── MUTATION BorrowMidnightRenewalCallback #3 ──────────────────────────────
 * @desc:   Allow renewal into the same market by flipping equality check; violates CLB-BMR-12
 * @rules:  callbackRevertsForSameSourceMarket
 * @conf:   certora/confs/callbacks/BorrowMidnightRenewalCallback/callbackRevertsForSameSourceMarket.conf
 * @status: killed
