/* ── MUTATION BorrowMidnightRenewalCallback #22 ──────────────────────────────
 * @desc:   fee transfer doubled: the fee recipient receives fee*2, pushing the paid tick fee past the sellerAssets bound on a non-reverting take — sellerTickFeeNeverExceedsAssets is violated.
 * @rules:  sellerTickFeeNeverExceedsAssets
 * @conf:   certora/confs/callbacks/BorrowMidnightRenewalCallback/sellerTickFeeNeverExceedsAssets.conf
 * @status: killed
