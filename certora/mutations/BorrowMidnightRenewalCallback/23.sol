/* ── MUTATION BorrowMidnightRenewalCallback #23 ──────────────────────────────
 * @desc:   onSell transferCollaterals source/target markets swapped : collateral flows target->source (BMR-03 add-while-reduce, BMR-04 remove-while-open)
 * @rules:  renewalCannotAddCollateralWhenReducingDebt,renewalCannotRemoveCollateralWhenOpeningDebt
 * @conf:   certora/confs/callbacks/BorrowMidnightRenewalCallback/perf_kill/renewalCannotAddCollateralWhenReducingDebt.conf
 * @status: killed
 * @target: src/callbacks/BorrowMidnightRenewalCallback.sol
 * Was:     callbackData.sourceMarket, market, seller, sourceMarketId, sourceDebtBefore, repayBudget
 * Now:     market, callbackData.sourceMarket, seller, sourceMarketId, sourceDebtBefore, repayBudget
 * ────────────────────────────────────────────────────────────────────*/
