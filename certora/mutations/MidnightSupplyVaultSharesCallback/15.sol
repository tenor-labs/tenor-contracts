/* ── MUTATION MidnightSupplyVaultSharesCallback #15 ───────────────────────
 * @desc:   onSell supplies vault shares onBehalf of loanToken instead of seller : the vault-share beneficiary is not the seller
 * @rules:  vaultShareBeneficiaryIsSeller
 * @conf:   certora/confs/callbacks/MidnightSupplyVaultSharesCallback/vaultShareBeneficiaryIsSeller.conf
 * @status: killed
