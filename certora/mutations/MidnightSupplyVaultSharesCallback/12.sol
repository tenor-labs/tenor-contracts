/* ── MUTATION MidnightSupplyVaultSharesCallback #12 ──────────────────────────────
 ...
 * @conf:   certora/confs/callbacks/MidnightSupplyVaultSharesCallback/perf/supplyMonotoneCollateral.conf
 * @status: killed
 ...
 * Now:     MORPHO_MIDNIGHT.withdrawCollateral(market, callbackData.collateralIndex, shares, seller, address(this));
 * ────────────────────────────────────────────────────────────────────*/
