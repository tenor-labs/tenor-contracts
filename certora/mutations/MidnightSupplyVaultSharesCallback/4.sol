/* ── MUTATION MidnightSupplyVaultSharesCallback #4 ──────────────────────────────
 * @desc:   Removing the vault asset validation allows a vault with mismatched underlying asset to pass through, breaking the rule that requires reverts on asset mismatch
 * @rules:  vaultAssetMismatchReverts
 * @conf:   certora/confs/callbacks/MidnightSupplyVaultSharesCallback/vaultAssetMismatchReverts.conf
 * @status: killed
