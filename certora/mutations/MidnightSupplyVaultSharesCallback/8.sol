/* ── MUTATION MidnightSupplyVaultSharesCallback #8 ──────────────────────────────
 * @desc:   wrong deposit amount: deposit(0) instead of deposit(totalDeposit) -> zero shares minted
 ...
 * Was:     uint256 shares = IERC4626(vault).deposit(totalDeposit, address(this));
 * Now:     uint256 shares = IERC4626(vault).deposit(0, address(this));
 * ────────────────────────────────────────────────────────────────────*/
