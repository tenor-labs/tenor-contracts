/* ── MUTATION MidnightSupplyVaultSharesCallback #11 ──────────────────────────────
 * @desc:   supplyCollateral amount shares -> shares-1 : one minted vault share is stranded, collateral delta != minted shares
 * @rules:  suppliedSharesMatchMintedShares
 * @conf:   certora/confs/callbacks/MidnightSupplyVaultSharesCallback/suppliedSharesMatchMintedShares.conf
 * @status: killed
 ...
 * Now:     MORPHO_MIDNIGHT.supplyCollateral(market, callbackData.collateralIndex, shares - 1, seller);
 * ────────────────────────────────────────────────────────────────────*/
