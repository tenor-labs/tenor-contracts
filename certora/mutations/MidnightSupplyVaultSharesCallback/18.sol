/* ── MUTATION MidnightSupplyVaultSharesCallback #18 ──────────────────────────────
 * @desc:   Credits the supplied vault shares as collateral to the callback contract instead of the seller, so the seller's collateral never increases and the witness proving a supply can raise the seller's collateral becomes unsatisfiable.
 ...
 * Now:     MORPHO_MIDNIGHT.supplyCollateral(market, callbackData.collateralIndex, shares, receiver);
 * ────────────────────────────────────────────────────────────────────*/
