/* ── MUTATION MidnightSupplyVaultSharesCallback #14 ───────────────────────
 * @desc:   onSell supplies to collateralIndex+1 (a non-vault slot) instead of the pinned vault slot : a non-vault collateral slot receives supply
 * @rules:  onlyVaultSlotReceivesSupply
 * @conf:   certora/confs/callbacks/MidnightSupplyVaultSharesCallback/onlyVaultSlotReceivesSupply.conf
 * @status: killed
 ...
 * Now:     MORPHO_MIDNIGHT.supplyCollateral(market, callbackData.collateralIndex + 1, shares, seller);
 * ────────────────────────────────────────────────────────────*/
