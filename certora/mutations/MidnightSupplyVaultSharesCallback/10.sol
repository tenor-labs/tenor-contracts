/* ── MUTATION MidnightSupplyVaultSharesCallback #10 ──────────────────────────────
 * @desc:   receiver guard != -> == : onSell no longer reverts when receiver isn't the callback (proceeds strand)
 * @rules:  receiverNotCallbackReverts
 * @conf:   certora/confs/callbacks/MidnightSupplyVaultSharesCallback/receiverNotCallbackReverts.conf
 * @status: killed
